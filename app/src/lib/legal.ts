...
export const TERMS: Doc = {
  ...
  blocks: [
    ...
    { k: 'p',
      en: 'You can leave at any time: **Profile → Delete account** removes your account and everything personal under it, immediately and permanently. No email required, no waiting period. That same screen offers **Download your data** first, so you can take a copy with you.',
      vi: 'Bạn có thể rời đi bất cứ lúc nào: **Hồ sơ → Xoá tài khoản** xoá tài khoản và mọi thứ cá nhân thuộc về nó, ngay lập tức và vĩnh viễn. Không cần gửi email, không phải chờ. Chính màn hình đó có **Tải dữ liệu của bạn** ở trên, để bạn mang một bản sao đi trước.' },
    { k: 'h2',
      en: 'No warranty',
      vi: 'Không bảo hành' },
    { k: 'p',
...
export const PRIVACY: Doc = {
  ...
  blocks: [
    ...
    { k: 'h2',
      en: 'Getting a copy of your data',
      vi: 'Lấy bản sao dữ liệu của bạn' },
    { k: 'p',
      en: '**Profile → Delete account → Download your data** writes everything we hold about your account — profile, collections, plans, likes, crew, preferences, history and the places you added — to a single JSON file, and hands it to your phone\'s share sheet. Nothing is uploaded and we keep no copy: the file is made on your device and goes only where you send it.',
      vi: '**Hồ sơ → Xoá tài khoản → Tải dữ liệu của bạn** ghi mọi thứ chúng tôi lưu về tài khoản của bạn — hồ sơ, bộ sưu tập, kế hoạch, lượt thích, crew, tuỳ chọn, lịch sử và những địa điểm bạn đã thêm — vào một tệp JSON duy nhất, rồi đưa cho trình chia sẻ của máy bạn. Không có gì được tải lên và chúng tôi không giữ bản sao nào: tệp được tạo ngay trên máy bạn và chỉ đi tới nơi bạn gửi.' },
    { k: 'p',
      en: 'Two things are deliberately not in it. Other people appear only by their public @handle, never by name, email or account id — a copy of your data must not become a copy of theirs. And reports are left out, because a report names the person it is about.',
      vi: 'Có hai thứ cố ý không nằm trong đó. Người khác chỉ xuất hiện bằng @handle công khai, không có tên, email hay id tài khoản — bản sao dữ liệu của bạn không được trở thành bản sao dữ liệu của họ. Và báo cáo vi phạm bị lược đi, vì một báo cáo nêu tên chính người bị báo cáo.' },
    { k: 'h2',
