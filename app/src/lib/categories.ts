...
export const CATEGORIES: Record<string, CategoryStyle> = {
  ...
  heritage: { en: 'Heritage', vi: 'Di sản & văn hóa', ja: '歴史・文化', icon: 'library-outline', color: '#D98A80' },
  nature: { en: 'Parks & lakes', vi: 'Công viên & hồ', ja: '公園・自然', icon: 'leaf-outline', color: '#8FBF8A' },
  markets: { en: 'Markets', vi: 'Chợ & mua sắm', ja: '市場・買い物', icon: 'bag-outline', color: '#C98BB0' },
  ...
  sights: { en: 'Sights', vi: 'Điểm tham quan', ja: '見どころ', icon: 'location-outline', color: '#9A9C98' },
};
