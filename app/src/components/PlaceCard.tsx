...
const s = StyleSheet.create({
  ...
  name: { flex: 1, color: colors.text, fontSize: 17, fontWeight: font.bold, letterSpacing: -0.2 },
  price: { color: colors.textSecondary, fontSize: 13, fontWeight: font.semibold },
  meta: { color: colors.textTertiary, fontSize: 12.5, fontWeight: font.medium, marginTop: 3 },
  vibes: { flexDirection: 'row', gap: 6, marginTop: 8 },
  vibe: {
    color: colors.textSecondary, fontSize: 11, fontWeight: font.semibold,
